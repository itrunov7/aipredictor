        ...
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-white">SP500 Insights</h1>
                <p className="text-xs text-gray-400 -mt-1">Powered by AI</p>
              </div>
            </div>
            <p className="text-gray-400 text-base">
              AI-powered stock analysis and predictions for S&P 500 companies. 
              Make smarter trading decisions with professional-grade insights.
            </p>
          ...
          <div className="md:flex md:items-center md:justify-between">
            ...
            <div className="mt-8 md:mt-0 md:order-1">
              <p className="text-base text-gray-400">
                &copy; 2024 SP500 Insights. All rights reserved.
              </p>
